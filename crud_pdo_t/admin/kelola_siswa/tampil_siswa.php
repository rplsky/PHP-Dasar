...
<div class="panel panel-default">
	<div class="panel-heading">
				<h3>
					...
					<a class="btn btn-primary" href="?modul=siswa&fitur=tambah_siswa">Tambah Data</a>
				</h3>
			</div>
							...
							while($data = $sql->fetch()){
								...
								<tbody>
									<tr>
										...
										<td>
                                            <a class="btn btn-warning" href="?modul=siswa&fitur=edit_siswa&id=<?php echo $data['nis'];?>">Edit</a> | 
                                            <a onclick="return confirm('Anda akan menghapus data ini?')" class="btn btn-danger" href="?modul=siswa&fitur=hapus_siswa&id=<?php echo $data['nis'];?>">Hapus</a>
                                        </td>
									</tr>
								</tbody>
								<?php
			...
			<ul class="pagination pagination-sm m-0 float-right">
				...
				?>
					<li class="page-item"><a class="page-link" href="?modul=siswa&fitur=tampil_siswa&hal=1">First</a></li>
					<li class="page-item"><a class="page-link" href="?modul=siswa&fitur=tampil_siswa&hal=<?php echo $link_prev; ?>">&laquo;</a></li>
				<?php
				}
				?>
				...
				?>
					<li class="page-item" <?php echo $link_active; ?>><a  class="page-link" href="?modul=siswa&fitur=tampil_siswa&hal=<?php echo $i; ?>"><?php echo $i; ?></a></li>
				<?php
				}
				?>
				...
				?>
					<li class="page-item"><a class="page-link" href="?modul=siswa&fitur=tampil_siswa&hal=<?php echo $link_next; ?>">&raquo;</a></li>
					<li class="page-item"><a class="page-link" href="?modul=siswa&fitur=tampil_siswa&hal=<?php echo $jumlah_hal; ?>">Last</a></li>
				<?php
				}
				?>
			</ul>
